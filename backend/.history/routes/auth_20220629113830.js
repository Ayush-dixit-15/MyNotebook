...
,(req,res)=>{
  const errors = validationResult(req);
    ...
    .catch(err=> {console.log(err)     
      ...
      // this here tells the system what to do whenever an irregularity is found . For example whenever we will find an entry with same email as what was stored in my database, it will display this error and message 
})
